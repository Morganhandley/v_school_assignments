...
function fight() {
    currentHitDamage = randomGenerator(1, 80);
    enemyFound.hitPoints -= currentHitDamage;
    if (enemyFound.hitPoints <= 0) {
        console.log(`Nice finishing hit!!! -${currentHitDamage} points! (${enemyFound.name}'s health: ${enemyFound.hitPoints})\n`);
